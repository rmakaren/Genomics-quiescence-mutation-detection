...
#-----------------------------------------------------------------------------
#I am a code monkey, I do not know how to merge it into a single function and push its to work with a list
...
all_together <- list_to_vectors(all_together)
write.table(all_together, file = "/home/rostyslav/Desktop/R_analysis/PhD_project/NGS_sequencing/6_subcultures/6_subcultures_filtrated.txt", sep="\t", quote=T, row.names=F, col.names=T)
